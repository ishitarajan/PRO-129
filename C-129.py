...
try:
    g = requests.get("https://www.imdb.com/search/title/?genres=fantasy&sort=user_rating,desc&title_type=feature&num_votes=25000,&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=5aab685f-35eb-40f3-95f7-c53f09d542c3&pf_rd_r=TFERG1SEN0R80ZTT66D9&pf_rd_s=right-6&pf_rd_t=15506&pf_rd_i=top&ref_=chttp_gnr_9")
    ...
    for movie in movies:
        ...
        sheet.append([movie_name,year,rating,story,director,gross])
except Exception as e:
    print(e)

excel.save("scrapper3.xlsx")